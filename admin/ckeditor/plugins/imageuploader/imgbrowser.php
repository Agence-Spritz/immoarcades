...
<?php if($show_settings) { ?>
    <div id="settingsDiv" class="lightbox popout">
        ...
        <?php if($news_sction == "yes"){ ?>
            <p class="uploadP" onclick="disableNews()"><img src="img/hide.png" class="headerIcon"> <?php echo $panelsettings21; ?></p>
        <?php } elseif($news_sction == "no") { ?>
            <p class="uploadP" onclick="enableNews()"><img src="img/show.png" class="headerIcon"> <?php echo $panelsettings22; ?></p>
        <?php } ?>-->
